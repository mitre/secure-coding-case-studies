...
To submit a new case study, start by creating a fork of the repository. The new case study can then be added to the fork. Once the case study is complete, a pull request can be created to submit the case study for potential inclusion.
